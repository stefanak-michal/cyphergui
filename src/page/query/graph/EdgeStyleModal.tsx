            ...
            <Modal
                ...
                <div className="field">
                    ...
                    <div className="control">
                        <input className="slider is-fullwidth" type="range" min="0" max="1" step=".1" value={this.props.currentSettings.width ?? .3}
                               onChange={(e) => this.props.handleStyleSet(this.props.type, 'width', e.currentTarget.valueAsNumber)} />
                    </div>
                </div>
                <div className="field">
                    ...
                    <div className="control">
                        <input className="slider is-fullwidth" type="range" min="0" max="10" step="1" value={this.props.currentSettings.fontSize ?? 4}
                               onChange={(e) => this.props.handleStyleSet(this.props.type, 'fontSize', e.currentTarget.valueAsNumber)} />
                    </div>
                </div>
